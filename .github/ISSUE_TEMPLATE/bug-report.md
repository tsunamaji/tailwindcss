---
name: Bug report
about: If you've already asked for help with a problem and confirmed something is broken with Tsunamaji itself, create a bug report.
title: ''
labels: ''
assignees: ''
---
...
**What version of Tsunamaji are you using?**
